  ...
  return (
    <div className="text-center max-w-5xl w-full items-center justify-between   mb-12 lg:mb-24">
      ...
      <div className="flex flex-col lg:flex-row">
        <div className="p-4 mb-4 lg:mb-0 lg:mr-2 flex-1 border-black dark:border-white border-2 flex-col justify-center">
          <h3 className="text-xl">
            Develop as you know it is out the door. Develop as you want it just
            arrived.
          </h3>
        </div>
        <div className="p-4 mb-4 lg:mb-0 lg:mr-2 lg:ml-2 flex-1 border-black dark:border-white border-2 flex-col justify-center">
          <h3 className="text-xl">
            Receive your code within a few business days on average, Monday to
            Friday.
          </h3>
        </div>
        <div className="p-4 flex-1 lg:ml-2 border-black dark:border-white border-2 flex-col justify-center">
          <h3 className="text-xl">
