  ...
  return (
    <div className="text-center max-w-5xl w-full items-center justify-between   mb-12 lg:mb-24 p-4">
      <div className="flex flex-col lg:flex-row  rounded-l-xl">
        <div className="p-4 flex flex-1 border-black  justify-center dark:border-white border-2 flex-col bg-white  lg:rounded-l-xl">
        ...
        <div className="p-4 lg:py-8 text-left flex-1 bg-[#F5F5F7]  lg:rounded-r-xl">
